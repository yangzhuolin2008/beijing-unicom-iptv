---
description: Update IPTV M3U playlist from source and local channel info
---
...
def update_iptv():
    ...
    # raw.githubusercontent.com usually doesn't use refs/heads/main, try to correct it to main if it fails
...
// turbo
```bash
python -c "import sys; sys.path.append(r'.'); import update_iptv_script; update_iptv_script.update_iptv()"
```
